...
const messages: Record<Locale, Record<string, string>> = {
  'zh-CN': {
    'app.title': 'SBM', language: 'EN', close: '关闭', logout: '退出', overview: '概览', protocols: '协议', settings: '设置', copied: '已复制',
  ...
  en: {
    'app.title': 'SBM', language: '中文', close: 'Close', logout: 'Sign out', overview: 'Overview', protocols: 'Protocols', settings: 'Settings', copied: 'Copied',
